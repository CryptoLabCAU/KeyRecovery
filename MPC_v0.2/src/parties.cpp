...
void PARTIES::loadFile()
{
    ...
    ifs >> this->t >> this->n >> this->pi >> lambda;

    switch (lambda)
    {
    case 160:
        this->curve_type = NID_secp160k1;
        break;
    case 192:
        this->curve_type = NID_secp192k1;
        break;
    case 224:
        this->curve_type = NID_secp224k1;
        break;
    case 256:
        this->curve_type = NID_secp256k1;
        break;
    default:
        this->curve_type = NID_secp256k1;
        break;
    ...
    for (int i = 0; i < n + 1; i++)
    {
        this->X[i] = EC_POINT_new(this->curve);

        memset(buf, 0x00, 1024);
        ifs >> buf;
        EC_POINT_hex2point(curve, buf, X[i], bn_ctx);
    }
